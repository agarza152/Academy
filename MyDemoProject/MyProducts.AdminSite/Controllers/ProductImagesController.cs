...
namespace MyProducts.AdminSite.Controllers
{
    public class ProductImagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Description,ImageURL,Active,ProductId")] ProductImage productImage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Description,ImageURL,Active,ProductId")] ProductImage productImage)
        {
            if (ModelState.IsValid)
            {
